...
try{
    ...
    window.addEventListener("hashchange", () =>{
        ...
        // if (hash==="men") {
        //     document.querySelector(".goods__title").innerHTML ="Мужчинам";
            
        // } else if (hash==="women") {
        //     document.querySelector(".goods__title").innerHTML ="Женщинам";
        // } else{
        //     document.querySelector(".goods__title").innerHTML ="Детям";
        // }
    })
